...
do
    ...
    nohup rsync -azPvL -e "ssh -A -o IdentityFile=~/.ssh/id_astro_compute_040418.pub $SCI_SYNC_USER@niagara.computecanada.ca ssh -A " nia-datamover1:$SRC_DIR/ $DEST_DIR $DEL_FLAG > rsyncCommand.log 2>&1 &
    wait
